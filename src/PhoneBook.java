...
//                contacts.add(new Contact(query.name, query.number));
            contacts.put(newContact.number, newContact);
        } else if (query.type.equals("del")) {
            contacts.remove(newContact.number);
        } else {
            String response = "not found";
            if (contacts.containsKey(newContact.number)) {
                response = contacts.get(newContact.number).name;
            }
